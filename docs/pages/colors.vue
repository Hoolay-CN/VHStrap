<template><section><h1>Colors (配色)</h1>
<p>定制了HOOLAY主色 <span style="background-color: #0096ff; display: inline-block; padding: 0 3px; color: #fff; font-size: 14px;">#0096FF</span></p>
